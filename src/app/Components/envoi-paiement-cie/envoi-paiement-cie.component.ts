...
export class EnvoiPaiementCieComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.httpClient.get(environment.urlFinal + 'efacture/commission/' +'CIE/'+ 2500).subscribe((da)=>{
      var i;
      for(i in da){
        console.log(da[i].commissionBanque)
      }
      console.log(da)
    })
    //// this.Envoyeur();
    ...
    this.httpClient
      ...
      .subscribe(
        (testFacture: any) => {
          ...
          // this.SODECIFACTURE = testFacture;
  ...
  //             console.log(JSON.stringify(this.paiementFacture) + 'CIE')
  ...
  //                 this.t24transaction.facturier = this.FacturierCie;
  ...
  //                   this.editForm.value.montantFacture;
  //                 this.envoiis.intituleFacturier = this.FacturierCie;
  //                 if (this.editForm.value.typePaye === 'Total') {
  ...
  //                 //   this.  .codeOperateur;
  //                 // console.log(this.cieTransaction.CodeOperateur);
  ...
  //                 // console.log(this.cieTransaction.DateReglement);
  //                 // if (typeReglement === 'Total') {
  ...
  //                 // console.log(this.cieTransaction.HeureReglement);
  //                 // this.cieTransaction.NumeroRecu = this.ReferenceT24;
  //                 // console.log(this.cieTransaction.NumeroRecu + 'NUMERO RECU');
  //                 // this.cieTransaction.RefContrat =
  //                 //   localStorage.getItem('refContrat');
  //                 // console.log(this.cieTransaction.RefContrat + 'REF CONTRAT ');
  //                 // this.cieTransaction.RefFacture =
  //                 //   this.editForm.value.identifiant;
  //                 // console.log(this.cieTransaction.RefFacture + 'refff');
  //                 // this.cieTransaction.TypeCanal = this.commissions.typeCanal;
  //                 // console.log(this.cieTransaction.TypeCanal + 'TYPE CANAL');
  ...
  //                 //           // console.log(this.referenceCie + 'reference CIE');
  ...
  //                 //     },
  //                 //     (error) => {
  //                 //       console.log('Paiement CIE' + JSON.stringify(error));
  //                 //       this.loader = false;
  //                 //       this.ErrorForm = this.fb.group({
  //                 //         httpStatusCode: '401',
  //                 //         methode: 'Paiement CIE',
  //                 //         login: localStorage.getItem('login'),
  //                 //         message: JSON.stringify(error.name),
  //                 //         description:
  //                 //           JSON.stringify(error.message) +
  ...
  OperationPaie() {
    ...
    if (
      ...
      this.httpClient.get<any>(environment.urlFinal + 'efacture/commission/' + this.FacturierCie +'/'+ montant).subscribe(
        (AllCommission) => {
            ...
            this.transactionService.Transaction(this.paiementFacture).subscribe(
              (T24: any) => {
                ...
                if (this.reponseT24.statut === 0) {
                  ...
                  // this.cieTransaction.CodeOperateur = this.commissions.codeOperateur;
                  console.log(this.cieTransaction.CodeOperateur);
                  //DATE PAIEMENT//
                  var madate = new Date();
                  ...
                  console.log(this.cieTransaction.DateReglement);
                  if (typeReglement === "Total") {
                    this.cieTransaction.MontantReglement = this.editForm.value.montantFacture;
                  }
                  else {
                    this.cieTransaction.MontantReglement = this.editForm.value.montantPaye;
                  }

                  //HEURE PAIEMENT//

                  var heure = new Date();
                  var cie = heure.toLocaleString('fr-FR', { hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: false });
                  var heureEnvoi = cie.toString();
                  var Heure_finale = heureEnvoi.replace(/:/g, '');

                  //SEND PARAMS TO CIE
                  this.cieTransaction.CodeOperateur = this.paramCommissions.codeOperateur
                  console.log(this.cieTransaction.CodeOperateur + 'COD')
                  this.cieTransaction.HeureReglement = Heure_finale;
                  console.log(this.cieTransaction.HeureReglement)
                  this.cieTransaction.NumeroRecu = this.ReferenceT24;
                  console.log(this.cieTransaction.NumeroRecu)
                  this.cieTransaction.RefContrat = this.contrat;
                  console.log(this.cieTransaction.RefContrat)
                  this.cieTransaction.RefFacture = this.editForm.value.identifiant;
                  console.log(this.cieTransaction.RefFacture + 'refff')
                  this.cieTransaction.TypeCanal = this.paramCommissions.typeCanal;
                  console.log(this.cieTransaction.TypeCanal)


                  console.log(JSON.stringify(this.cieTransaction) + 'CIEEEEEE')

                  this.transactionService.TransactionCie(this.cieTransaction).subscribe((retourPaiementCie: TraitementCie) => {
                    ...
                    if (this.ListeretourPaiementCie.CodeTraitement === 0) {
                      ...
                      console.log(JSON.stringify(this.historique) + 'ieizeizeizezi')
                      this.factureService.AddHistorique(this.historique).subscribe(
                        (histfacture: Consultation) => {
                          console.log(JSON.stringify(histfacture) + 'Consultation');
                          if (histfacture) {
                              ...
                              .subscribe(
                                (t24Response) => {
                                  ...
                                  if (t24Response) {
                                    ...
                                    console.log(this.envoiis.frais +  'FRAIS')
                                    this.onSubmit(this.envoiis).subscribe(
                                      (paiement: Facture) => {
                                        console.log('PAIEMENT' + JSON.stringify(paiement));
                                        if (paiement) {
                      ...
                      console.log(this.historique.statut + 'STATUT INSERT CO 1')
                      this.factureService.AddHistorique(this.historique).subscribe(
                        (histfacture: Consultation) => {
                          console.log(JSON.stringify(histfacture) + 'Consultation');
                          if (histfacture) {
                              ...
                              .subscribe(
                                (t24Response) => {
                                  ...
                                  if (t24Response) {
                                    ////////////////////////////////////// INSERTION TABLE PAIEMENT//////////////////////////////////////////
                                    this.envoiis.identifiant = this.editForm.value.identifiant;
                                    console.log(this.envoiis.identifiant + 'ID')
                                    ...
                                    this.envoiis.numCpt = this.editForm.value.numCpt;
                                    console.log(this.envoiis.numCpt + 'NUMCPT')
                                    this.envoiis.typePaye = this.editForm.value.typePaye;
                                    this.envoiis.reference = this.noOper;
                                    this.envoiis.codeReponse = this.refExterne;
                                    this.envoiis.frais = this.commissions.montantCommission;
  ...
  // this.cieTransaction.NumeroRecu = this.ReferenceT24;
  // console.log(this.cieTransaction.NumeroRecu);
  // this.cieTransaction.RefContrat = this.ReferenceContrat;
  // console.log(this.cieTransaction.RefContrat);
  // this.cieTransaction.RefFacture = this.editForm.value.identifiant;
  // console.log(this.cieTransaction.RefFacture + 'refff');
  // this.cieTransaction.TypeCanal = this.commissions.typeCanal;
  ...
  //*** INSERTION TABLE CONSULTATION ***//
  //   this.historique.identifiant = this.cieTransaction.RefFacture;
  //   console.log(this.historique.identifiant + 'consul');
  //   this.historique.dtExpFacture = expirationDate;
  ...
  //         console.log( this.cieTransaction.DateReglement);
  //         this.cieTransaction.MontantReglement = this.editForm.value.montantFacture;
  //         console.log( this.cieTransaction.MontantReglement);
  ...
  //         console.log( this.cieTransaction.RefContrat)
  //         this.cieTransaction.RefFacture = this.editForm.value.identifiant;
  //         console.log( this.cieTransaction.RefFacture)
  //         this.cieTransaction.TypeCanal = this.commissions.typeCanal;
  //         console.log(  this.cieTransaction.TypeCanal)
  //         this.transactionService.TransactionCie(this.cieTransaction).subscribe((retourPaiementCie : TraitementCie)=>{
  //         console.log(retourPaiementCie);
  ...
  consul() {
    ...
    this.cieTransaction.CodeOperateur = '22'; //this.commissions.codeOperateur;
    console.log(this.cieTransaction.CodeOperateur);
    //DATE PAIEMENT//
    var madate = new Date();
    var Dates = madate.toLocaleString('fr-FR', {
    ...
    this.cieTransaction.RefFacture = this.editForm.value.identifiant;
    console.log(this.cieTransaction.RefFacture);
    this.cieTransaction.TypeCanal = 55; //this.commissions.typeCanal;
    console.log(this.cieTransaction.TypeCanal);
    // this.transactionService.TransactionCie(this.cieTransaction).subscribe((retourPaiementCie : TraitementCie)=>{
    // console.log(retourPaiementCie);
    // this.ListeretourPaiementCie = retourPaiementCie;
